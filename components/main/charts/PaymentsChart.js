...
const TotalPayTooltip = ({active, payload}) => {
    if (active && payload && payload.length) {
        const {date_proc, success_total_pay, error_total_pay, processing_total_pay, total_pay} = payload[0].payload;
        const formattedDate = new Date(date_proc).toLocaleDateString('ru-RU');

        return (
            <div className="card card-body" style={{background: '#fff', padding: '10px', border: '1px solid #ccc'}}>
    ...
    return (
        <div className="d-flex justify-content-between">
            <div className="w-75 d-flex flex-column">
                <div className="card ps-3 p-2">
                    <div className="d-flex flex-row mb-3 mt-2 w-100 align-items-center justify-content-between">
                    ...
                    <ResponsiveContainer width="100%" height={420}>
                        ...
                        >
                            ...
                            <Area type="monotone" dataKey="success_real_pay" stackId="1" stroke="green" fill="green"
                                  name="Успешные"/>
                            <Area type="monotone" dataKey="error_real_pay" stackId="1" stroke="red" fill="red"
                                  name="Ошибочные"/>
                            <Area type="monotone" dataKey="processing_real_pay" stackId="1" stroke="orange"
                                  fill="orange" name="В обработке"/>
                            <Area type="monotone" dataKey="real_pay" stroke="darkBlue" fill="none" name="Итого"/>
                        </AreaChart>
                    </ResponsiveContainer>
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Area type="monotone" dataKey="success_total_count" stackId="1" stroke="green" fill="green"
                                  name="Успешные"/>
            ...
            <div className="w-25 ms-4 text-nowrap">
                ...
                <DealerBalance/>
                <PaymentsToday data={data} loading={loading}/>
            </div>
        </div>
    );
};

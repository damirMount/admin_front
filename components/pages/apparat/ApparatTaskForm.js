                            ...
                            <>
                                {taskResult.status === 'info' && (
                                    <Result
                                        ...
                                        subTitle="С помощью этого меню вы можете удалённо запускать различные конады для
...
export default ApparatTaskForm;

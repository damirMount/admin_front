            ...
            <div className="af-whitelist-panel shadow-sm">
                ...
                {client.comment && (
                    <Row gutter={0} className='border-top'>
                        <Col span={24} className="p-2 px-4 af-panel-section d-flex flex-column align-items-start main-info">
                            <Text type="secondary" className="af-tiny-label d-block">КОММЕНТАРИЙ:</Text>
                ...
                {/* ТРЕТЬЯ ЛИНИЯ (Футер) */}
                <Row gutter={0} align="middle" className='border-top'>
                    <Col span={12} className="af-panel-section main-info p-2 d-flex justify-content-between">
                        <Text type="secondary" className='af-text-xs ms-3'>REDIS KEY</Text>
                        <Text type="secondary" className='af-text-xs me-3' copyable={true}>
                            {combinedKey}
                        </Text>
                    </Col>
                    <Col span={12} className="p-2 d-flex justify-content-between">

                        <Text type="secondary" className='af-text-xs ms-3'>Оператор:
                            <span className='ms-1'>{loadingOperator ? 'Загрузка...' : (operatorName || 'Система')}</span>
                        </Text>

                        <Text type="secondary" className='af-text-xs me-3'>{FormatDate(client.operator_update_at)} </Text>
                    </Col>
                </Row>
            </div>

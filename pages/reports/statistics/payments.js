...
export default function PaymentsStatisticsPage() {
    ...
    // Новое состояние для отслеживания выбранного статуса платежа
    ...
    const handleSearch = async (formValues, currentModes) => {
        ...
        // Сохраняем текущий статус фильтрации
                    ...
                    <Row gutter={[12, 12]}>
                        <Col span={12}>
                            <Card className="shadow-sm h-100 d-flex align-items-center">
                                <Space size={24}>
                                    <Statistic title="Проведено (Сумма)" value={totalSummary.all.real_pay} precision={2}
                                               suffix={"KGS"}/>
                                    <Divider type="vertical" style={{height: "50px"}}/>
                                    <Statistic title="Количество платежей" value={totalSummary.all.count}
                                               suffix={"ед."}/>
                                </Space>
                            </Card>
                        </Col>
                        ...
                        <Col span={12}>
                            <div className="p-3 rounded-3 h-100 bg-light border">
                                ...
                                <div className="d-flex justify-content-between align-items-center pt-4">
                                    ...
                                    <Divider type="vertical" className="finance-divider"/>
                                    <MoneyColumn label="В рублях (RUR)" value={totalSummary.all.real_pay_rur}
                    ...
                    <Col span={24}>
                        <Card title="Детализированные данные куба отчета" size="small" className="shadow-sm">
                            <PaymentsStatisticsTable
                                ...
                                dictionaries={dictionaries}// Передаем статус фильтра
                            />
                        </Card>
                    </Col>
                </Row>

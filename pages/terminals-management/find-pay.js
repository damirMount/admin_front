                ...
                <div className="d-flex flex-row justify-content-start mt-3">
                    ...
                    <div className='w-75 h-100 d-flex flex-column align-content-between justify-content-between'>
                        ...
                        <div className="d-flex flex-column card card-body align-items-start ms-3">
                            ...
                            <Text> Выберите терминал, а затем укажите реквизит платежа, по которому нужно найти логи.
                                В списке отображаются только активные терминалы — если нужного терминала нет, проверьте
                                его статус в админке.
                                Обратите внимание: первая выгрузка логов может занять некоторое время, так как они
                                загружаются с терминала на сервер.
                                Повторные запросы за ту же дату обрабатываются значительно быстрее, но логи за текущий
                                день будут загружаются заново при каждом запросе, чтобы обеспечить актуальность данных.
                            </Text>
